...
app = FastAPI(
    title="Investment MCP System Controller", 
    version="1.0.0",
    description="Backend system controller for Investment MCP dashboard operations"
)

# Enable CORS for frontend - more restrictive in production
app.add_middleware(
    CORSMiddleware,
...
async def get_system_logs(component: str = None, level: str = None, limit: int = 100):
    """Get system logs"""
    # Mock logs for now - in production, implement proper log aggregation
    logs = [
        {
